...
const proxyOptions = {
     ...
     Socker.HTTP(proxyOptions, (connection, error) => {
         ...
         const tlsOptions = {
            ...
            secureProtocol: ['TLSv1_2_method', 'TLS_method', 'TLS_client_method', 'TLSv1_3_method', 'SSL_OP_NO_SSLv3', 'SSL_OP_NO_SSLv2', 'TLS_OP_NO_TLS_1_1', 'TLS_OP_NO_TLS_1_0',],
        };
